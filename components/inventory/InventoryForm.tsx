    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                {/* DADOS DE ENTRADA - MOVED TO HEADER */}
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <FormField control={form.control} name="supplier" render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-xl font-bold text-slate-700">Fornecedor</FormLabel>
                            <FormControl><Input className="h-16 text-xl font-medium" placeholder="Nome do Fornecedor" {...field} /></FormControl>
                            <FormMessage className="text-lg" />
                        </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="invoice_number" render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-xl font-bold text-slate-700">Número da NF</FormLabel>
                            <FormControl><Input className="h-16 text-xl font-medium" placeholder="Ex: 000.123" {...field} /></FormControl>
                            <FormMessage className="text-lg" />
                        </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="entry_date" render={({ field }) => (
                        <FormItem>
                            <FormLabel className="text-xl font-bold text-slate-700">Data Lançamento</FormLabel>
                            <FormControl><Input type="date" className="h-16 text-xl font-medium" {...field} /></FormControl>
                            <FormMessage className="text-lg" />
                        </FormItem>
                    )} />
                </div>
