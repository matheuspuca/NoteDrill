                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <FormField control={form.control} name="chassis" render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-xl font-bold text-slate-700">Série / Chassi</FormLabel>
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        ...
                        <FormField control={form.control} name="hourmeter" render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl><Input className="h-16 text-xl font-medium" type="number" step="0.1" {...field} /></FormControl>
                                <FormMessage className="text-lg" />
                            </FormItem>
                        )} />
